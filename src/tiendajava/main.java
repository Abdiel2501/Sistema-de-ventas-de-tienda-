...
public class main {
    public static void main(String[] args) {
        ...
        Cajero pedro = new Cajero("Pedro", "1", "pedro", caja, inventario);
        ...
        do {
            ...
            do {
                System.out.println("\n=== INICIAR SESIÓN ===");
                System.out.print("Ingresa el id (o -1 para salir del sistema): ");
                int id = 0;
                if (sc.hasNextInt()) {
                    id = sc.nextInt();
                    sc.nextLine();
            ...
            switch (eleccion) {
                case 1:
                    do {
                        ...
                        System.out.println("1- Realizar venta completa (Escanear y Cobrar).");
                        System.out.println("2- Consultar stock individual.");
                        System.out.println("3- Limpiar venta actual.");
                        ...
                        switch (eleccion) {
                            case 1:
                                pedro.realizarVentaCompleta(sc);
                                break;
                            case 2:
